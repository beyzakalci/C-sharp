...
namespace otomasyon
{
    public partial class Form3 : Form
    {
        ...
        private void personelleri_goster()
        {
            ...
            {
                baglantim.Open();
                OleDbDataAdapter personelleri_listele = new OleDbDataAdapter("select tcno AS[TC Kimlik No], ad AS[ADI],soyad AS[SOYADI], cinsiyet as[CİNSİYETİ],mezuniyet as[MEZUNİYETİ],dogumtarihi as[DOĞUM TARİHİ],gorevi as[GÖREVİ], gorevyeri as [GÖREV YERİ], maasi as [MAAŞI] from personeller Order By ad ASC", baglantim);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (maskedTextBox1.Text.Length == 11)
            {
                ...
                MessageBox.Show("Tc Kimlik No'yu doğru giriniz.", "Otomasyon", MessageBoxButtons.OK, MessageBoxIcon.Error);
